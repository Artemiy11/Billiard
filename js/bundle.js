...
function modal() {
  var modalBtn = document.querySelector('.timer__button'),
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var timer = __webpack_require__(/*! ./timer */ "./src/js/timer.js"),
      modal = __webpack_require__(/*! ./modal */ "./src/js/modal.js"),
      validator = __webpack_require__(/*! ./validatator */ "./src/js/validatator.js"),
      form = __webpack_require__(/*! ./form */ "./src/js/form.js"),
...
function slider() {
  ...
  function showSlides() {
    ...
    dots.forEach(function (item) {
      return item.classList.remove('dot_active');
    });
...
function validator() {
  // Mask
  $("input[name=phone]").mask("+7(999) 999-9999"); // Validate forms
